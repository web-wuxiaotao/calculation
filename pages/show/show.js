Page({
  ...
  cal:function(){
    ...
    var mm=a/mn;
    var m=parseFloat((mm)+a*mr).toFixed(2);
    var i=parseFloat([(mm+a*mr)+mm*(1+mr)]/2*mn-a).toFixed(2);
    var t=parseFloat([(mm+a*mr)+mm*(1+mr)]/2*mn).toFixed(2);
    var n=parseFloat(mm*mr).toFixed(2);
    self.setData({
      monthPay:m,
      decline:n,
      interest:i,
